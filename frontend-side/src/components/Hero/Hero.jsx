      ...
      <div className="container">
        <div className="hero-content">
          <h1 className="h1 hero-title">
            Make money driving with Dereva wangu in Kenya.
          </h1>
          <p className="hero-text">
            Become a dereva wangu driver, set your schedule and earn money by
            driving!
          </p>
          ...
          <div className="slider-inner">
            <ul className="slider-container" data-slider-container>
              <li className="slider-item">
                ...
                >
                  <img
                    src="./assets/images/MicrosoftTeams-image-54.png"
                    style={{ "--width": 575, "--height": 550 }}
                    alt=""
                    className="img-cover"
                  />
